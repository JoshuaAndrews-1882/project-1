...
### Content
  ...
  - A guide on how to make the content responsive for different sized screens and was used to help create the nav and the three images with times below was taken from [Eugenio on YouTube](https://www.youtube.com/channel/UCdPMJB0w--p9xrlvFeYz5wA).
...
## Future Improvements
  ...
  - To make improvements to the layout and visual aspects of the website once I learn more skills.
